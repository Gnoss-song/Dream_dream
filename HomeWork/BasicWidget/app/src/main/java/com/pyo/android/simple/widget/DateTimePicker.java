...
public class DateTimePicker extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView = findViewById(R.id.text_display_current_datetime);
        final DatePicker datePicker = findViewById(R.id.date_picker_widget);
        final TimePicker timePicker = findViewById(R.id.time_picker_widget);
