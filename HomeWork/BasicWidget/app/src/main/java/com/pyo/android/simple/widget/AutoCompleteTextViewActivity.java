	   ...
	   protected void onCreate(Bundle savedInstanceState) {
	     ...
	     ArrayAdapter<String> adapter =
	                 new ArrayAdapter<String>(
	                     ...
	                     android.R.layout.simple_dropdown_item_1line,
	                     autoColors);
	     AutoCompleteTextView autoEdit = findViewById(R.id.auto_complete_text_view);
	     //위젯과 어댑터 연결
	     autoEdit.setAdapter(adapter);
	        
	     MultiAutoCompleteTextView multiAutoEdit = findViewById(R.id.multi_auto_complete_text_view);
	     multiAutoEdit.setAdapter(adapter);
	     //제시어 목록을 구분할 구분자(콤마) 설정
	     multiAutoEdit.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());
	   }
}