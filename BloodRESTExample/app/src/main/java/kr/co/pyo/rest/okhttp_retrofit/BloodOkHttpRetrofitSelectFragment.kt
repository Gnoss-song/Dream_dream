...
class BloodOkHttpRetrofitSelectFragment : Fragment() {
    companion object {
        fun newInstance(): BloodOkHttpRetrofitSelectFragment {
            return BloodOkHttpRetrofitSelectFragment()
        }
    }
    ...
    private fun selectBlood() {
        ...
        val bloodService = RetrofitOkHttpManager.bloodRESTService
        val call: Call<BloodModel> = bloodService.requestBloodSelect()
