...
class BloodOkHttpRetrofitRESTActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(bloodAdapter){
            appendFragment(BloodOkHttpRetrofitInsertFragment.newInstance())
            appendFragment(BloodOkHttpRetrofitSelectFragment.newInstance())
