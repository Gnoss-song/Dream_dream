...
import kr.co.mapo.basicwidget.SimpeViewCallBackEventActivity

abstract class AndroidEventListActivity:BaseActivity() {
    override fun displayActivityList () {
        addActionMap("3.1.뷰 콜백 이벤트구현", SimpeViewCallBackEventActivity)
        //addActionMap("3.2.액티비티 콜백 이벤트 구현" ,ActivityCallbackEventActivity .class);
        addActionMap("3.2.이벤트우선순위샘플", EventPriorityActivity)
