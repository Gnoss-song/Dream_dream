...
package kr.co.softcampus.myapplication123123.databinding;
...
public final class MyDialogBinding implements ViewBinding {
  ...
  private MyDialogBinding(@NonNull LinearLayout rootView, @NonNull Button cancel,
      @NonNull TextView content, @NonNull Button ok) {
  ...
  public static MyDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MyDialogBinding((LinearLayout) rootView, cancel, content, ok);
    }
