 ...
 * @desc
 */
class CalendarAdapter(private val context: Context, private val calendarLayout: LinearLayout, val date: Date) :
    ...
    inner class CalendarItemHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        fun bind(data: Int, position: Int, context: Context) {
            ...
            if (position < firstDateIndex || position > lastDateIndex) {
                itemCalendarDateText.setTextAppearance(R.style.TextAppearance_AppCompat_Large)
