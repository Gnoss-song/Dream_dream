...
public final class NavigationHeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final CircleImageView naviHeaderImage;

  private NavigationHeaderBinding(@NonNull LinearLayout rootView,
      @NonNull CircleImageView naviHeaderImage) {
    this.rootView = rootView;
    this.naviHeaderImage = naviHeaderImage;
  }
  ...
  public static NavigationHeaderBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.navi_header_image;
      CircleImageView naviHeaderImage = rootView.findViewById(id);
      if (naviHeaderImage == null) {
        break missingId;
      }

      return new NavigationHeaderBinding((LinearLayout) rootView, naviHeaderImage);
    }
