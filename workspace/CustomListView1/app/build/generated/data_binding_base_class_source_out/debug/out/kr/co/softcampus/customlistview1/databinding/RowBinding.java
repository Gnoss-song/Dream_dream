...
package kr.co.softcampus.customlistview1.databinding;
...
import kr.co.softcampus.customlistview1.R;
...
public final class RowBinding implements ViewBinding {
  ...
  private RowBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static RowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowBinding((LinearLayout) rootView, progressBar, rowTextView);
    }
