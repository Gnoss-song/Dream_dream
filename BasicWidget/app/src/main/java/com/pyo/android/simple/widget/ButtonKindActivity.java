...
public class ButtonKindActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Button selectorButton = findViewById(R.id.selector_applied_btn);
        ...
        toggleButton.setOnClickListener(new View.OnClickListener() {
	       public void onClick(View v) {
	          TextView tv =  findViewById(R.id.text_feature);
	          tv.setText(toggleButton.isChecked() ? "토글 ON" : "토글  off");
	       }
         });
		
        final Button submitButton =  findViewById(R.id.submit_demo);
        submitButton.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View v ){
	            ToggleButton tb =  findViewById(R.id.toggle_button);
	            Toast.makeText(ButtonKindActivity.this, tb.isChecked() ?
		             "on": "off", Toast.LENGTH_LONG).show();
		              ButtonKindActivity.this.finish();
	        }
	    });
       final CheckBox checkButton =  findViewById(R.id.checkbox);
      ...
      final Button clearChoice = findViewById(R.id.Button01);
 ...
 */
 public void selectorAppliedButtonOnClick(View selectorButton){
	 ...
	 if(selectorButton.isEnabled()){
	   Toast.makeText(this, buttonTagMessage + " 비활성화 됩니다!", Toast.LENGTH_SHORT).show();
